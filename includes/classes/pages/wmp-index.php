...
function wmp_index() {
	...
	<div class="wmp_page wmp_index">
		<div class="wrap">
			...
			<h1><?php esc_attr_e( 'Callisto', 'wpMercuryParser' ); ?></h1>
						...
						<div class="meta-box-sortables ui-sortable">
							...
							<div class="postbox">
								...
								<div class="inside">
									...
									<input type="hidden" id="wmp_fetch_posts_nonce" value="<?php echo esc_attr( $wmp_fetch_posts_nonce ); ?>">
									<input type="hidden" id="wmp_fetch_posts_ajax_url" value="<?php echo esc_attr( $wmp_fetch_posts_ajax_url ); ?>">

									<textarea id="wmp_urls_field" name="wmp_urls_field" cols="80" rows="10" class="wmp_urls"></textarea>
									...
									if ( ! empty( $wmp_post_types ) ) {
										...
										foreach ( $wmp_post_types as $wmp_post_type ) {
											?>
												<option value="<?php echo esc_attr( $wmp_post_type ); ?>"><?php echo esc_html( $wmp_post_type ); ?></option>
											<?php
										}
										?>
										</select>
